...
import { EditProjectModalProps, ProjectType } from "../../projects.types";

import { MAX_SIZE_MB } from "@/constants/data";
import CropModal from "@/components/ImageCropper";


const EditProjectModal: React.FC<EditProjectModalProps> = ({ isOpen, onClose, initialValues, reloadData }) => {
    ...
    const handleSubmit = async (
        ...
        try {
            ...
            formData.append("projectId", String(initialValues.id));
                    ...
                    {({ values, setFieldValue, isSubmitting }) => (
                        <Form>
                            ...
                            <div className="flex justify-end space-x-2 p-4">
                                ...
                                >
                                    {isLoading || isSubmitting ? "Updating..." : "Update Project"}
                                </button>
                            </div>
                        </Form>
                    )}
